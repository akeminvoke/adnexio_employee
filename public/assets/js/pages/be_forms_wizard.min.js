...
! function(e) {
  ...
  i.m = e, i.c = a, i.d = function(e, a, r) {
    ...
    if (i.r(r), Object.defineProperty(r, "default", {
      ...
      for (var t in e) i.d(r, t, function(a) {
        return e[a]
      }.bind(null, t));
    return r
  }, i.n = function(e) {
  ...
  19: function(e, a, i) {
    ...
    var t = function() {
      ...
      return function(e, a, i) {
        ...
        value: function() {
          jQuery(".js-wizard-simple").bootstrapWizard({
            onTabShow: function(e, a, i) {
              var r = (i + 1) / a.find("li").length * 100,
                t = a.parents(".block").find('[data-wizard="progress"] > .progress-bar');
              t.length && t.css({
                width: r + 1 + "%"
              })
            }
        ...
        value: function() {
          var e = jQuery(".js-wizard-validation-form"),
            a = jQuery(".js-wizard-validation2-form");
          e.add(a).on("keyup keypress", function(e) {
          ...
          jQuery(".js-wizard-validation").bootstrapWizard({
            ...
            onNext: function(a, r, t) {
              if (!e.valid()) return i.focusInvalid(), !1
            },
            onTabClick: function(e, a, i) {
              return jQuery("a", a).blur(), !1
            }
            ...
            onNext: function(e, i, t) {
              if (!a.valid()) return r.focusInvalid(), !1
            },
            onTabClick: function(e, a, i) {
              return jQuery("a", a).blur(), !1
            }
